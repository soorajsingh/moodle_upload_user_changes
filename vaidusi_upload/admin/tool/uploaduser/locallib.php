...
class uu_progress_tracker {
    private $_row;
    public $columns = array('status', 'line', 'id', 'username', 'firstname', 'lastname', 'email', 'password', 'auth', 'enrolments', 'suspended', 'deleted', 'branch', 'dept'); //chetan_edit
    ...
    public function start() {
        ...
        echo '<th class="header c'.$ci++.'" scope="col">'.'branch'.'</th>'; //chetan_edit
        echo '<th class="header c'.$ci++.'" scope="col">'.'dept'.'</th>'; //chetan_edit
        echo '</tr>';
        $this->_row = null;
    }
